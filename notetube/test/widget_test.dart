...
import 'package:notetube/main.dart';

void main() {
  testWidgets('NoteTube App Test', (WidgetTester tester) async {
    // Build our app and trigger a frame
    await tester.pumpWidget(const NoteTubeApp());
    ...
    expect(find.text('No transcription yet.'), findsOneWidget);
  });
}
